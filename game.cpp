...
void playGame () {
    ...
    if (!initSDL()) {
        ...
        printPic("pics/sudoku.png");
            while(playMore) {
                soundEffect = Mix_LoadWAV("C:/Users/fpt/Downloads/game-start-6104.wav");
                Mix_PlayChannel(1,soundEffect,0);
                soundEffect = Mix_LoadWAV("C:/Users/fpt/Downloads/sound.wav");
                bool isNotPlaying = false;
                int i = 0, j = 0;
                bool GridActive = false;
                myFont = TTF_OpenFont("C:/Users/fpt/Desktop/OpenSans-VariableFont_wdth,wght.ttf", 120);
                if (myFont == nullptr) {
                ...
                while (!isNotPlaying) {
                    ...
                    if (isAllFilled(mainboard) || (isAllFilled(mainboard) && isWin(mainboard))) {
                        soundEffect = Mix_LoadWAV("C:/Users/fpt/Downloads/Victory Sound Effect.wav");
                        Mix_PlayChannel(1,soundEffect,0);
                        isNotPlaying = true;
                        printPic("C:/Users/fpt/Downloads/winning.png");
                    }
                }
            }
        closeSDL(mainboard);
